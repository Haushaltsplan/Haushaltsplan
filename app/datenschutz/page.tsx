      ...
      <article className="space-y-8 text-sm leading-relaxed text-[var(--app-text-muted)]">
        ...
        <section className="space-y-3">
          ...
          <ul className="list-disc space-y-2 pl-5">
            ...
            <li>
              ...
              Speisekammer, Kalender, Portfolio) — Inhalte je nach Bereich in Supabase oder nur lokal
        ...
        <section className="space-y-3">
          ...
          <ul className="list-disc space-y-2 pl-5">
            ...
            <li>Google Gemini / OpenAI (KI-Funktionen, z. B. Kassenbon — nur bei aktiver Nutzung)</li>
