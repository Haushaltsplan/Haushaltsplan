...
export const SEKTOR_MANTRAS: readonly SektorMantraBlock[] = [
  {
    id: 'software-saas',
...
export function findeSektorMantra(id: string): SektorMantraBlock | null {
  return SEKTOR_MANTRAS.find((b) => b.id === id) ?? null
}
