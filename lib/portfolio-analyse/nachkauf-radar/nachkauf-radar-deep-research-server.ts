...
export async function fuhreDeepResearchDurch(
  ...
  const platzhalter: NachkaufScanEintrag[] = [{
    ...
    ampel: 'grau', score: 0,
    scoreDetail: { mantraScore: 0, bewertungsScore: 0, sellTriggerPenalty: 0, historischerBewertungsBonus: 0, datenSignaleDelta: 0, momentumPunkte: 0, strukturPunkte: 0, drawdownBonus: 0, insiderPunkte: 0, datenVollstaendigkeitPct: 0, gesamt: 0 },
