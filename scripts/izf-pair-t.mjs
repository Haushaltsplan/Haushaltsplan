...
const flows = parqetPairedFlows()
const T = 94943.53
console.log('full pair @ T', T, berechneIrrAnnualizedPercent(flows, T, asOf))

function findT(target) {
  let lo = 70000, hi = 100000
  for (let i = 0; i < 60; i++) {
    const mid = (lo + hi) / 2
...
console.log('T for 6.43 full pair:', findT(6.43))
