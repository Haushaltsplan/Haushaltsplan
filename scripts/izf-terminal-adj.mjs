...
const flows = skipAktienDivFlows()
const Tadj = T - divBrutto
console.log('divBrutto', divBrutto, 'Tadj', Tadj)
console.log('skip aktiendiv + bar div @ T:', berechneIrrAnnualizedPercent(flows, T, asOf))
console.log('skip aktiendiv + bar div @ T-divBrutto:', berechneIrrAnnualizedPercent(flows, Tadj, asOf))
...
console.log('divAll @ T-divBrutto:', berechneIrrAnnualizedPercent(divAllFlows(), Tadj, asOf))
